...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Error adding duplicate items
//public void addMenuItem(String menuItems) {
         //   if (menuItems.contains(menuItems)) {
//System.out.println("Warning: The item \"" + menuItems + "\" is already on the menu.");
         //   } else {
          //      menuItems.add(menuItems);
           //     System.out.println("Item \"" + menuItems + "\" added to the menu.");
          //  }
      //  }

        // Print the menu
        System.out.println(menu);
        System.out.println(menuItems.get(menuItems.indexOf(burger)));
